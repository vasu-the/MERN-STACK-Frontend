...
//       <input type="text" placeholder="Mobile" value={agent.mobile} onChange={(e) => setAgent({ ...agent, mobile: e.target.value })} />
//       <input type="password" placeholder="Password" value={agent.password} onChange={(e) => setAgent({ ...agent, password: e.target.value })} />
